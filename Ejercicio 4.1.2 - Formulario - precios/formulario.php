               ...
               <div id="zona2">
                    ...
                    <?php 
                         if(isset($_POST['fotoActual'])) {
                               echo $_POST['fotoActual']; 
                         } else {
                              echo $ruta;}
                         ?>
                         " height="200px" width="200px" alt="Foto de peinado no encontrada">
               </div>
          </div>
     </div>
     <script>
        window.onload = function() {
               document.getElementById("seleccion").selectedIndex =
               document.getElementById("elementoActual").value;
               elijofoto("<?php echo $camino ?>");
        }
