...
<?php
    ...
    $correo = $_POST["correo"];    
    $mensaje = "";
    $pagina = "http://localhost/proyectos/Ejercicio%2018%20-%20Formulario%20de%20Alta/verificar.php?nombre=".$usuario.'&hash='.$hash;
    ...
    $mail = new PHPMailer(true);
        ...
        try {
            ...
            $mail->setFrom('cursodactw2021@gmail.com', 'Curso');
            ...
            $mail->Body    = $mensaje;
            http://localhost:8080/proyectos/Ejercicio%2018%20-%20Formulario%20de%20Alta/correo.php
